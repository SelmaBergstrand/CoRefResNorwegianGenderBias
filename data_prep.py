...
def generate_benchmark_prompts():
    for i in range(len(MALE_OCCUPATIONS)):
        ...
        occ_female = FEMALE_OCCUPATIONS[i]
        sentence = SENTENCE_TEMPLATES[i]
        PROMPTS.append(replace_placeholders(sentence, occ_male + " " + names[0], occ_female + " " + names[1], "han"))
        PROMPTS.append(replace_placeholders(sentence, occ_male + " " + names[0], occ_female + " " + names[1], "hun"))
        PROMPTS.append(replace_placeholders(sentence, occ_male + " " + names[1], occ_female + " " + names[0], "han"))
        PROMPTS.append(replace_placeholders(sentence, occ_male + " " + names[1], occ_female + " " + names[0], "hun"))

        PROMPTS.append(replace_placeholders(sentence, occ_female + " " + names[0], occ_male + " " + names[1], "han"))
        PROMPTS.append(replace_placeholders(sentence, occ_female + " " + names[0], occ_male + " " + names[1], "hun"))
        PROMPTS.append(replace_placeholders(sentence, occ_female + " " + names[1], occ_male + " " + names[0], "han"))
        PROMPTS.append(replace_placeholders(sentence, occ_female + " " + names[1], occ_male + " " + names[0], "hun"))
        sentence = SENTENCE_TEMPLATES[i + 5]
        PROMPTS.append(replace_placeholders(sentence, occ_male + " " + names[0], occ_female + " " + names[1], "han"))
        PROMPTS.append(replace_placeholders(sentence, occ_male + " " + names[0], occ_female + " " + names[1], "hun"))
        PROMPTS.append(replace_placeholders(sentence, occ_male + " " + names[1], occ_female + " " + names[0], "han"))

...
# results manually transferred from excel sheet
...
# plot piechart of decisions made by LLMs
...
# count position of pro- and anti-stereotypical decisions
...
# plot positions by decision (pro or anti stereotypical)
fig, (ax1, ax2) = plt.subplots(1, 2)
